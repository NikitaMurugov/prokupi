...
+function (a) {
  ...
  g.prototype = {
    ...
    updateVal: function updateVal(a, b) {
      var d, e, f, g, h, i, j;
  ...
  a.fn.bfhcolorpicker = function (b) {
    return this.each(function () {
      var c, d, e;
      c = a(this), d = c.data("bfhcolorpicker"), e = "object" == _typeof(b) && b, this.type = "bfhcolorpicker", d || c.data("bfhcolorpicker", d = new g(this, e)), "string" == typeof b && d[b].call(c);
    });
  ...
  var b = function b(_b, c) {
    this.options = a.extend({}, a.fn.bfhcountries.defaults, c), this.$element = a(_b), this.$element.is("select") && this.addCountries(), this.$element.hasClass("bfh-selectbox") && this.addBootstrapCountries(), this.$element.is("span") && this.displayCountry();
  };
  ...
  b.prototype = {
    ...
    addCountries: function addCountries() {
      ...
      for (b in c) {
        c.hasOwnProperty(b) && this.$element.append('<option value="' + b + '">' + c[b] + "</option>");
      }
  ...
  a.fn.bfhcountries = function (c) {
    return this.each(function () {
      var d, e, f;
      d = a(this), e = d.data("bfhcountries"), f = "object" == _typeof(c) && c, e || d.data("bfhcountries", e = new b(this, f)), "string" == typeof c && e[c].call(d);
    });
  ...
  var b = function b(_b2, c) {
    this.options = a.extend({}, a.fn.bfhcurrencies.defaults, c), this.$element = a(_b2), this.$element.is("select") && this.addCurrencies(), this.$element.hasClass("bfh-selectbox") && this.addBootstrapCurrencies(), this.$element.is("span") && this.displayCurrency();
  };
  ...
  b.prototype = {
    ...
    getCurrencies: function getCurrencies() {
      ...
      if (this.options.available) {
        ...
        for (b in BFHCurrenciesList) {
          BFHCurrenciesList.hasOwnProperty(b) && a.inArray(b, this.options.available) >= 0 && (c[b] = BFHCurrenciesList[b]);
        }
    ...
    addCurrencies: function addCurrencies() {
      ...
      for (b in c) {
        c.hasOwnProperty(b) && this.$element.append('<option value="' + b + '">' + c[b].label + "</option>");
      }
    ...
    addBootstrapCurrencies: function addBootstrapCurrencies() {
      ...
      for (e in f) {
        f.hasOwnProperty(e) && (this.options.flags === !0 ? (g = f[e].currencyflag ? f[e].currencyflag : e.substr(0, 2), c.append('<li><a tabindex="-1" href="#" data-option="' + e + '"><i class="glyphicon bfh-flag-' + g + '"></i>' + f[e].label + "</a></li>")) : c.append('<li><a tabindex="-1" href="#" data-option="' + e + '">' + f[e].label + "</a></li>"));
      }
  ...
  a.fn.bfhcurrencies = function (c) {
    return this.each(function () {
      var d, e, f;
      d = a(this), e = d.data("bfhcurrencies"), f = "object" == _typeof(c) && c, e || d.data("bfhcurrencies", e = new b(this, f)), "string" == typeof c && e[c].call(d);
    });
  ...
  i.prototype = {
    ...
    setDateLimit: function setDateLimit(a, b) {
      var c, d;
    ...
    updateCalendarHeader: function updateCalendarHeader(a, b, c) {
      var d, e;

      for (a.find("table > thead > tr > th.month > span").text(BFHMonthsList[b]), a.find("table > thead > tr > th.year > span").text(c), d = a.find("table > thead > tr.days-header"), d.html(""), e = BFHDayOfWeekStart; e < BFHDaysList.length; e += 1) {
        d.append("<th>" + BFHDaysList[e] + "</th>");
      }

      for (e = 0; BFHDayOfWeekStart > e; e += 1) {
        d.append("<th>" + BFHDaysList[e] + "</th>");
      }
    },
    checkMinDate: function checkMinDate(a, b, c) {
      var d, e, f, g;
    ...
    checkMaxDate: function checkMaxDate(a, b, c) {
      var d, e, f, g;
    ...
    checkToday: function checkToday(a, b, c) {
      var d;
      return d = new Date(), a === d.getDate() && b === d.getMonth() && c === d.getFullYear() ? !0 : !1;
    },
    updateCalendarDays: function updateCalendarDays(a, d, e) {
      var f, g, h, i, j, k, l;

      for (f = a.find("table > tbody").html(""), g = b(d, e), h = b(d + 1, e), i = c(d, e, 1), j = c(d, e, h), k = "", l = 0; (i - BFHDayOfWeekStart + 7) % 7 > l; l += 1) {
        k += '<td class="off">' + (g - (i - BFHDayOfWeekStart + 7) % 7 + l + 1) + "</td>";
      }

      for (l = 1; h >= l; l += 1) {
        k += this.checkMinDate(l, d, e) ? '<td data-day="' + l + '" class="off">' + l + "</td>" : this.checkMaxDate(l, d, e) ? '<td data-day="' + l + '" class="off">' + l + "</td>" : this.checkToday(l, d, e) ? '<td data-day="' + l + '" class="today">' + l + "</td>" : '<td data-day="' + l + '">' + l + "</td>", c(d, e, l) === (6 + BFHDayOfWeekStart) % 7 && (f.append("<tr>" + k + "</tr>"), k = "");
      }

      for (l = 1; (7 - (j + 1 - BFHDayOfWeekStart + 7) % 7) % 7 + 1 >= l; l += 1) {
        k += '<td class="off">' + l + "</td>", l === (7 - (j + 1 - BFHDayOfWeekStart + 7) % 7) % 7 && f.append("<tr>" + k + "</tr>");
      }
    },
  ...
  a.fn.bfhdatepicker = function (b) {
    return this.each(function () {
      var c, d, e;
      c = a(this), d = c.data("bfhdatepicker"), e = "object" == _typeof(b) && b, this.type = "bfhdatepicker", d || c.data("bfhdatepicker", d = new i(this, e)), "string" == typeof b && d[b].call(c);
    });
  ...
  var b = function b(_b3, c) {
    this.options = a.extend({}, a.fn.bfhfonts.defaults, c), this.$element = a(_b3), this.$element.is("select") && this.addFonts(), this.$element.hasClass("bfh-selectbox") && this.addBootstrapFonts();
  };
  ...
  b.prototype = {
    ...
    getFonts: function getFonts() {
      ...
      if (this.options.available) {
        ...
        for (b in BFHFontsList) {
          BFHFontsList.hasOwnProperty(b) && a.inArray(b, this.options.available) >= 0 && (c[b] = BFHFontsList[b]);
        }
    ...
    addFonts: function addFonts() {
      ...
      for (b in c) {
        c.hasOwnProperty(b) && this.$element.append('<option value="' + b + '">' + b + "</option>");
      }
    ...
    addBootstrapFonts: function addBootstrapFonts() {
      ...
      for (e in f) {
        f.hasOwnProperty(e) && c.append('<li><a tabindex="-1" href="#" style=\'font-family: ' + f[e] + "' data-option=\"" + e + '">' + e + "</a></li>");
      }
  ...
  a.fn.bfhfonts = function (c) {
    return this.each(function () {
      var d, e, f;
      d = a(this), e = d.data("bfhfonts"), f = "object" == _typeof(c) && c, e || d.data("bfhfonts", e = new b(this, f)), "string" == typeof c && e[c].call(d);
    });
  ...
  var b = function b(_b4, c) {
    this.options = a.extend({}, a.fn.bfhfontsizes.defaults, c), this.$element = a(_b4), this.$element.is("select") && this.addFontSizes(), this.$element.hasClass("bfh-selectbox") && this.addBootstrapFontSizes();
  };
  ...
  b.prototype = {
    ...
    getFontsizes: function getFontsizes() {
      ...
      if (this.options.available) {
        ...
        for (b in BFHFontSizesList) {
          BFHFontSizesList.hasOwnProperty(b) && a.inArray(b, this.options.available) >= 0 && (c[b] = BFHFontSizesList[b]);
        }
    ...
    addBootstrapFontSizes: function addBootstrapFontSizes() {
      ...
      for (e in f) {
        f.hasOwnProperty(e) && c.append('<li><a tabindex="-1" href="#" data-option="' + e + '">' + f[e] + "</a></li>");
      }
  ...
  a.fn.bfhfontsizes = function (c) {
    return this.each(function () {
      var d, e, f;
      d = a(this), e = d.data("bfhfontsizes"), f = "object" == _typeof(c) && c, e || d.data("bfhfontsizes", e = new b(this, f)), "string" == typeof c && e[c].call(d);
    });
  ...
  var b = function b(_b5, c) {
    this.options = a.extend({}, a.fn.bfhgooglefonts.defaults, c), this.$element = a(_b5), this.$element.is("select") && this.addFonts(), this.$element.hasClass("bfh-selectbox") && this.addBootstrapFonts();
  };
  ...
  b.prototype = {
    ...
    getFonts: function getFonts() {
      var b, c;
      if (c = [], this.options.subset) for (b in BFHGoogleFontsList.items) {
        BFHGoogleFontsList.items.hasOwnProperty(b) && a.inArray(this.options.subset, BFHGoogleFontsList.items[b].subsets) >= 0 && (c[BFHGoogleFontsList.items[b].family] = {
        ...
        for (b in BFHGoogleFontsList.items) {
          BFHGoogleFontsList.items.hasOwnProperty(b) && a.inArray(BFHGoogleFontsList.items[b].family, this.options.available) >= 0 && (c[BFHGoogleFontsList.items[b].family] = {
            info: BFHGoogleFontsList.items[b],
            index: parseInt(b, 10)
          });
        }
      } else for (b in BFHGoogleFontsList.items) {
        BFHGoogleFontsList.items.hasOwnProperty(b) && (c[BFHGoogleFontsList.items[b].family] = {
          info: BFHGoogleFontsList.items[b],
          index: parseInt(b, 10)
        });
      }
    ...
    addFonts: function addFonts() {
      ...
      for (b in c) {
        c.hasOwnProperty(b) && this.$element.append('<option value="' + c[b].info.family + '">' + c[b].info.family + "</option>");
      }
    ...
    addBootstrapFonts: function addBootstrapFonts() {
      ...
      for (e in f) {
        f.hasOwnProperty(e) && c.append('<li><a tabindex="-1" href="#" style="background-position: 0 -' + (30 * f[e].index - 2) + 'px;" data-option="' + f[e].info.family + '">' + f[e].info.family + "</a></li>");
      }
  ...
  a.fn.bfhgooglefonts = function (c) {
    return this.each(function () {
      var d, e, f;
      d = a(this), e = d.data("bfhgooglefonts"), f = "object" == _typeof(c) && c, e || d.data("bfhgooglefonts", e = new b(this, f)), "string" == typeof c && e[c].call(d);
    });
  ...
  var b = function b(_b6, c) {
    this.options = a.extend({}, a.fn.bfhlanguages.defaults, c), this.$element = a(_b6), this.$element.is("select") && this.addLanguages(), this.$element.is("span") && this.displayLanguage(), this.$element.hasClass("bfh-selectbox") && this.addBootstrapLanguages();
  };
  ...
  b.prototype = {
    ...
    getLanguages: function getLanguages() {
      ...
      if (this.options.available) {
        ...
        for (b in this.options.available) {
          this.options.available.hasOwnProperty(b) && (-1 !== this.options.available[b].indexOf("_") ? (a = this.options.available[b].split("_"), c[a[0]] = {
    ...
    addLanguages: function addLanguages() {
      ...
      for (c in b) {
        b.hasOwnProperty(c) && (b[c].hasOwnProperty("name") ? this.$element.append('<option value="' + c + "_" + b[c].country + '">' + b[c].name.toProperCase() + " (" + BFHCountriesList[b[c].country] + ")</option>") : this.$element.append('<option value="' + c + '">' + b[c].toProperCase() + "</option>"));
      }
  ...
  a.fn.bfhlanguages = function (c) {
    return this.each(function () {
      var d, e, f;
      d = a(this), e = d.data("bfhlanguages"), f = "object" == _typeof(c) && c, e || d.data("bfhlanguages", e = new b(this, f)), "string" == typeof c && e[c].call(d);
    });
  ...
  var b = function b(_b7, c) {
    this.options = a.extend({}, a.fn.bfhnumber.defaults, c), this.$element = a(_b7), this.initInput();
  };
  ...
  b.prototype = {
    ...
    formatNumber: function formatNumber() {
      var a, b, c, d;
      if (a = this.getValue(), a > this.options.max && (a = this.options.wrap === !0 ? this.options.min : this.options.max), a < this.options.min && (a = this.options.wrap === !0 ? this.options.max : this.options.min), this.options.zeros === !0) for (b = String(this.options.max).length, c = String(a).length, d = c; b > d; d += 1) {
        a = "0" + a;
      }
  ...
  a.fn.bfhnumber = function (c) {
    return this.each(function () {
      var d, e, f;
      d = a(this), e = d.data("bfhnumber"), f = "object" == _typeof(c) && c, e || d.data("bfhnumber", e = new b(this, f)), "string" == typeof c && e[c].call(d);
    });
  ...
  function b(a, b) {
    ...
    for (c = "", b = String(b).replace(/\D/g, ""), d = 0, e = 0; d < a.length; d += 1) {
      /\d/g.test(a.charAt(d)) ? a.charAt(d) === b.charAt(e) ? (c += b.charAt(e), e += 1) : c += a.charAt(d) : "d" !== a.charAt(d) ? ("" !== b.charAt(e) || "+" === a.charAt(d)) && (c += a.charAt(d)) : "" === b.charAt(e) ? c += "" : (c += b.charAt(e), e += 1);
    }
  ...
  e.prototype = {
    ...
    changeCountry: function changeCountry(b) {
      var c, d;
  ...
  a.fn.bfhphone = function (b) {
    return this.each(function () {
      var c, d, f;
      c = a(this), d = c.data("bfhphone"), f = "object" == _typeof(b) && b, d || c.data("bfhphone", d = new e(this, f)), "string" == typeof b && d[b].call(c);
    });
  ...
  a.fn.bfhselectbox = function (b) {
    return this.each(function () {
      var c, d, f;
      c = a(this), d = c.data("bfhselectbox"), f = "object" == _typeof(b) && b, this.type = "bfhselectbox", d || c.data("bfhselectbox", d = new e(this, f)), "string" == typeof b && d[b].call(c);
    });
  ...
  var b = function b(_b8, c) {
    this.options = a.extend({}, a.fn.bfhslider.defaults, c), this.$element = a(_b8), this.initSlider();
  };
  ...
  b.prototype = {
    ...
    updateHandle: function updateHandle(a) {
      var b, c, d, e;
    ...
    updateVal: function updateVal(a) {
      var b, c, d, e, f;
  ...
  a.fn.bfhslider = function (c) {
    return this.each(function () {
      var d, e, f;
      d = a(this), e = d.data("bfhslider"), f = "object" == _typeof(c) && c, this.type = "bfhslider", e || d.data("bfhslider", e = new b(this, f)), "string" == typeof c && e[c].call(d);
    });
  ...
  var b = function b(_b9, c) {
    this.options = a.extend({}, a.fn.bfhstates.defaults, c), this.$element = a(_b9), this.$element.is("select") && this.addStates(), this.$element.hasClass("bfh-selectbox") && this.addBootstrapStates(), this.$element.is("span") && this.displayState();
  };
  ...
  b.prototype = {
    ...
    loadStates: function loadStates(a) {
      var b, c;
      ...
      for (c in BFHStatesList[a]) {
        BFHStatesList[a].hasOwnProperty(c) && this.$element.append('<option value="' + BFHStatesList[a][c].code + '">' + BFHStatesList[a][c].name + "</option>");
      }
    ...
    loadBootstrapStates: function loadBootstrapStates(a) {
      var b, c, d, e, f, g;
    ...
    changeBootstrapCountry: function changeBootstrapCountry(b) {
      var c, d, e;
  ...
  a.fn.bfhstates = function (c) {
    return this.each(function () {
      var d, e, f;
      d = a(this), e = d.data("bfhstates"), f = "object" == _typeof(c) && c, e || d.data("bfhstates", e = new b(this, f)), "string" == typeof c && e[c].call(d);
    });
  ...
  a.fn.bfhtimepicker = function (b) {
    return this.each(function () {
      var c, d, e;
      c = a(this), d = c.data("bfhtimepicker"), e = "object" == _typeof(b) && b, this.type = "bfhtimepicker", d || c.data("bfhtimepicker", d = new f(this, e)), "string" == typeof b && d[b].call(c);
    });
  ...
  var b = function b(_b10, c) {
    this.options = a.extend({}, a.fn.bfhtimezones.defaults, c), this.$element = a(_b10), this.$element.is("select") && this.addTimezones(), this.$element.hasClass("bfh-selectbox") && this.addBootstrapTimezones();
  };
  ...
  b.prototype = {
    ...
    loadTimezones: function loadTimezones(a) {
      var b, c;
      b = this.options.timezone, this.$element.html(""), this.options.blank === !0 && this.$element.append('<option value=""></option>');

      for (c in BFHTimezonesList[a]) {
        BFHTimezonesList[a].hasOwnProperty(c) && this.$element.append('<option value="' + c + '">' + BFHTimezonesList[a][c] + "</option>");
      }
    ...
    loadBootstrapTimezones: function loadBootstrapTimezones(a) {
      var b, c, d, e, f;
      ...
      for (f in BFHTimezonesList[a]) {
        BFHTimezonesList[a].hasOwnProperty(f) && d.append('<li><a tabindex="-1" href="#" data-option="' + f + '">' + BFHTimezonesList[a][f] + "</a></li>");
      }
  ...
  a.fn.bfhtimezones = function (c) {
    return this.each(function () {
      var d, e, f;
      d = a(this), e = d.data("bfhtimezones"), f = "object" == _typeof(c) && c, e || d.data("bfhtimezones", e = new b(this, f)), "string" == typeof c && e[c].call(d);
    });
...
/***/ 3:
/*!*********************************************************!*\
  !*** multi ./resources/js/bootstrap-formhelpers.min.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\resources\js\bootstrap-formhelpers.min.js */"./resources/js/bootstrap-formhelpers.min.js");
